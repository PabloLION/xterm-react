...
- Resolved 2025-10-18 by copying key consumer-app files into worker directories (see `fix(compat-matrix): copy consumer files for workers`). Monitor for regressions when Vite config changes.
